# craete a new folder and copy pickle file and train dataset
# Web app developement using streamlit
...
# Once the code is completed with the above lines. Open termianl and run
